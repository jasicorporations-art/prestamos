# Script para desplegar a Vercel - PROYECTO SISI
# Despliega siempre en sisi.vercel.app
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "DESPLIEGUE A VERCEL - PROYECTO SISI" -ForegroundColor Cyan
Write-Host "sisi.vercel.app" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
# PASO 1: Desvincular del proyecto actual
Write-Host "Paso 1: Desvinculando del proyecto actual..." -ForegroundColor Yellow
if (Test-Path .vercel) {
    Remove-Item -Recurse -Force .vercel
    Write-Host "  ✓ Carpeta .vercel eliminada" -ForegroundColor Green
} else {
...
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
Write-Host "Desplegado en: sisi.vercel.app" -ForegroundColor Green
Write-Host ""
